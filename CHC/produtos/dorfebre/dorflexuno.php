            ...
            <div class="quadro-produtos positionAbsolute">
                ...
                <div class="content-page ajuste-content-page gondola">
                                ...
                                <div class="areaContentGondolaEsq2 d-table">
                                    <div class="d-table-cell v-align-middle">
                                        ...
                                        <p class="textBoxGondola font-14 colorWhite">
                                            • Ser a marca com mais frentes <br>
                                            na categoria de analgésicos <br>
                                            versus os concorrentes <br>
                                            (Neosaldina e Advil);<br><br>

                                            • Buscar ter sempre uma frente <br>
                                            a mais que Neosaldina.<br><br>

                                            • Dorflex deve estar sempre <br>
                                            ao lado de neosaldina;<br><br>

                                            • Nunca posicionar ao lado <br>
                                            de Dorflex Regular<br><br>

                                            • Nunca deixar similares <br>
                                            e genéricos ao lado de Dorflex.
                    ...
                    <div data-layer-set=".GONDOLA" class="GONDOLA l2 layer">
                        <div class="conteudoGondola d-inline-block">
                            ...
                            <div data-layer-set=".GONDOLAPLANOGRAMAUNO" class="GONDOLAPLANOGRAMAUNO l1 layer show" >
                                <div class="d-inline-block float-right">
                                    <div class="areaContentGondolaDir">
                            ...
                            <div data-layer-set=".GONDOLAPLANOGRAMAUNO" class="GONDOLAPLANOGRAMAUNO l2 layer" >
                                <div class="d-inline-block float-right">
                    ...
                    <div data-layer-set=".GONDOLA" class="GONDOLA l3 layer">
                        <div class="conteudoGondola d-inline-block">
                            ...
                            <div data-layer-set=".GONDOLAPLANOGRAMAUNOG" class="GONDOLAPLANOGRAMAUNOG l1 layer show" >
                                <div class="d-inline-block float-right">
                                    <div class="areaContentGondolaDir">
                            ...
                            <div data-layer-set=".GONDOLAPLANOGRAMAUNOG" class="GONDOLAPLANOGRAMAUNOG l2 layer" >
                                <div class="d-inline-block float-right">
                                    <div class="areaContentGondolaDir">
                ...
                <div class="content-page ajuste-content-page educacao">
                    ...
                    <div data-layer-set=".EDUCACAO" class="EDUCACAO l1 layer show">
                        <div class="conteudoEducacao d-inline-block text-center">
                            <div class="box-dorflex-educacao">
                                <p class="uppercase font-24 textBoxEducacao3 colorTitle" style="padding: 20px 0px 5px 0px">Dorflex Vs Dorflex uno</p>
                            </div>
                            <div class="d-inline-block">
                                <div class="d-table float-left" style="height: 371px">
                                    <img src="../../webroot/img/produtos/dorfebre/dorflexuno/dorflexunoEdu-1.png"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div data-layer-set=".EDUCACAO" class="EDUCACAO l2 layer">
                        <div class="conteudoEducacao d-inline-block text-center">
                            <div class="box-dorflex-educacao">
                                <p class="uppercase font-24 textBoxEducacao3 colorTitle" style="padding: 20px 0px 5px 0px">POTENTE CONTRA ENXAQUECA</p>
                            </div>
                            <div class="d-inline-block">
                                <div class="d-table float-left" style="height: 371px">
                                    <img src="../../webroot/img/produtos/dorfebre/dorflexuno/dorflexunoEdu-2.png"/>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="areaContentMerchanAllegraDirProd">
                                            ...
                                            <div class="float-right areaImgProdMerchan d-table">
                                                <div class="d-table-cell v-align-middle text-center">
                                                    <img src="../../webroot/img/produtos/<?= $categoria ?>/<?= $produto ?>/<?= $produto.'Merchan-' ?>faixa.png"/>
