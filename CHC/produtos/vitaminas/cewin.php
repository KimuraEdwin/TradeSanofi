                                ...
                                <div class="areaContentGondolaEsq2 d-table">
                                    <div class="d-table-cell v-align-middle">
                                        ...
                                        <p class="textBoxGondola font-14 colorWhite">
                                            • Principais concorrentes: Ceboin; Redoxon; Bio C; Cenevit;<br><br>

                                            • Garantir 3 frentes na gôndola;<br><br>

                                            • Posicionado ao lado de Redoxon.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="content-page ajuste-content-page educacao">
                    ...
                    <div data-layer-set=".EDUCACAO" class="EDUCACAO l1 layer show">
                        <div class="conteudoEducacao text-center">
                            ...
                            <div class="areaContentEducacaoAllegraDir2 d-table text-left" style="margin:150px auto; width:676px; height:154px; padding-left:50px">
                                
                                <div class="d-table-cell v-align-middle">
                                    <p class="textBoxEducacao3 font-16 colorTitle">
                                        Comunicar o novo posicionamento da marca: 
                                    </p>
                                    <p class="textBoxEducacao3 font-16 colorWhite">
                                        “Reforça a imunidade para o vai e vem da vida”, <br>
                                        não só no inverno, mas o ano inteiro.
                                    </p>
                                </div>
                                    ...
                                    <div class="d-inline-block float-right">
                                        <div class="areaContentMerchanAllegraDirProd">
                                            ...
                                            <div class="float-left areaDescProdMerchan">
                                                ...
                                                <p class="descMerchanProd">
                                                    1º e 2º Bolso: Cewin Cprs:<br>
                                                    2 Frentes / 2 profundidade.<br><br>

                                                    3º e 4º Bolso: Cewin Efev:<br>
                                                    2 Frentes / 2 profundidade.<br><br>

                                                    Grade total: 8 unidades.
                                                </p>
                                            </div> 
