    ...
    $("#REDE").on('change', function(){
        ...
        if( selected === "EXTRAFARMA" ){
            ...
            var rede = '<div class="btn-filtro d-flex j-content-center a-items-center">'+
                            '<input type="text" id="REDE" name="REDE" class="text-filtro" value="EXTRAFARMA" style="padding-left: 10px;" readonly>'+
                        '</div>'
            ...
            var regiao =    '<div class="btn-filtro d-flex j-content-center a-items-center" style="opacity:0;position:absolute;z-index:-1;top:0">'+
                                '<select id="REGIAO" name="REGIAO" class="text-filtro campo-3">'+
            ...
            var tipoMobiliario = '<div class="btn-filtro d-flex j-content-center a-items-center" style="opacity:0;position:absolute;z-index:-1;top:0">'+
                                    '<select id="TIPO_DE_MOBILIARIO" name="TIPO_DE_MOBILIARIO" class="text-filtro">'+
                                        '<option value="-" selected>tipo de mobiliário</option>'+
                                    '</select>'+
                                '</div>'
            ...
            $("#PLANOGRAMA").on('change', function(){

                var varREDE = $('#REDE').val()
                var varCATEGORIA = $('#CATEGORIA').val()
                var varPERFIL_LOJA = $('#PERFIL_LOJA').val()
                var varREGIAO = $('#REGIAO').val()
                var varNUMERO_DE_MODULOS = $('#NUMERO_DE_MODULOS').val()
                var varALTURA_DO_MOBILIARIO = $('#ALTURA_DO_MOBILIARIO').val()
                var varTIPO_DE_MOBILIARIO = $('#TIPO_DE_MOBILIARIO').val()
                var varPLANOGRAMA = $('#PLANOGRAMA').val()

                $.get("../../DPSP/layout/index.php?REDE="+varREDE+"&CATEGORIA="+varCATEGORIA+"&PERFIL_LOJA="+varPERFIL_LOJA+"&REGIAO="+varREGIAO+"&NUMERO_DE_MODULOS="+varNUMERO_DE_MODULOS+"&ALTURA_DO_MOBILIARIO="+varALTURA_DO_MOBILIARIO+"&TIPO_DE_MOBILIARIO="+varTIPO_DE_MOBILIARIO+"&PLANOGRAMA="+varPLANOGRAMA, data => {
                    $("#content-plan-geral").html(data)
                })

                //$("#input-opt").append("<input type='submit' value='entrar' class='btn-entrar-filtro'>")
        ...
        else if( selected === "DPSP" ){
            
            var rede = '<div class="btn-filtro d-flex j-content-center a-items-center">'+
                            '<input type="text" id="REDE" name="REDE" class="text-filtro" value="DPSP" style="padding-left: 10px;" readonly>'+
                        '</div>'
            ...
            var regiao =    '<div class="btn-filtro d-flex j-content-center a-items-center">'+
            ...
            var tipoMobiliario = '<div class="btn-filtro d-flex j-content-center a-items-center">'+
                                    '<select id="TIPO_DE_MOBILIARIO" name="TIPO_DE_MOBILIARIO" class="text-filtro" disabled>'+
            ...
            $("#CATEGORIA").on('change', function(){
                ...
                $.getScript("../../webroot/js/lista_dpsp.js", function(){
                    var listageral = lista.filter(filtrarResultado).map(pegarfiltro)
                    var qtd = [listageral[0]]
                    for (var i = 0; i < listageral.length; i++ ){
                        if(listageral[i+1]){
            ...
            $("#PERFIL_LOJA").on('change', function(){
                ...
                $.getScript("../../webroot/js/lista_dpsp.js", function(){
                    ...
                    $("#REGIAO").empty()
                    $("#REGIAO").append("<option value=''>região</option>")
        ...
        else if( selected === "RAIA DROGASIL" ){
            
            var rede = '<div class="btn-filtro d-flex j-content-center a-items-center">'+
                            '<input type="text" id="REDE" name="REDE" class="text-filtro" value="RAIA DROGASIL" style="padding-left: 10px;" readonly>'+
                        '</div>'
            ...
            $("#CATEGORIA").on('change', function(){
                ...
                $.getScript("../../webroot/js/lista_raiadrogasil.js", function(){
                    var listageral = lista.filter(filtrarResultado).map(pegarfiltro)
                    var qtd = [listageral[0]]
                    for (var i = 0; i < listageral.length; i++ ){
                        if(listageral[i+1]){
        ...
        else if( selected === "PAGUEMENOS" ){
            
            var rede = '<div class="btn-filtro d-flex j-content-center a-items-center">'+
                            '<input type="text" id="REDE" name="REDE" class="text-filtro" value="PAGUEMENOS" style="padding-left: 10px;" readonly>'+
                        '</div>'
            ...
            var perfilLoja = '<div class="btn-filtro d-flex j-content-center a-items-center" style="opacity:0;position:absolute;z-index:-1;top:0">'+
                                '<select id="PERFIL_LOJA" name="PERFIL_LOJA" class="text-filtro campo-2">'+
                                    '<option value="-" selected>perfil loja</option>'+
                                '</select>'+
                            '</div>'
            ...
            $("#CATEGORIA").on('change', function(){
                ...
                $.getScript("../../webroot/js/lista_paguemenos.js", function(){
                    var listageral = lista.filter(filtrarResultado).map(pegarfiltro)
                    var qtd = [listageral[0]]
                    for (var i = 0; i < listageral.length; i++ ){
                        if(listageral[i+1]){
