...
$(document).ready(function (b) {
    ...
    $("#close-popup").on("click", function(){
        $("#popup-planograma").removeClass("show-flex")
    })
    $("#show-popup").on("click", function(){
        $("#popup-planograma").addClass("show-flex")
    })

    $("[data-layer-planograma]").click(function(){
        var next = $(this).attr('data-layer-planograma')
        $(".PLANOGRAMA-VA").removeClass("show")
        $(".PLANOGRAMA-VA"+next).addClass('show')
    })
    $("[data-layer-planograma-zoom]").click(function(){
        var next = $(this).attr('data-layer-planograma-zoom')
        $(".PLANOGRAMA-ZOOM-VA").removeClass("show")
        $(".PLANOGRAMA-ZOOM-VA"+next).addClass('show')
        console.log(next)
    })
    $("[data-layer-planograma-zoom-v]").click(function(){
        var next = $(this).attr('data-layer-planograma-zoom-v')
        $(".PLANOGRAMA-ZOOM-V-VA").removeClass("show")
        $(".PLANOGRAMA-ZOOM-V-VA"+next).addClass('show')
    })

    $("[data-layer-table]").click(function(){
        var next = $(this).attr('data-layer-table')
        $(".TABLE-PLANOGRAMA-VA").removeClass("show")
        $(".TABLE-PLANOGRAMA-VA"+next).addClass('show')
    })
    $("[data-layer-table-zoom]").click(function(){
        var next = $(this).attr('data-layer-table-zoom')
        $(".TABLE-ZOOM-PLANOGRAMA-VA").removeClass("show")
        $(".TABLE-ZOOM-PLANOGRAMA-VA"+next).addClass('show')
    })
    $("[data-layer-view-g]").click(function(){
        var next = $(this).attr('data-layer-view-g')
        $(".PLANOGRAMA-VIEW").removeClass("show-flex")
        $(".PLANOGRAMA-VIEW"+next).addClass('show-flex')
    })
});