        ...
        <div id="bg" class="stage">
            ...
            <div class="quadro positionAbsolute">
                ...
                <div class="content-page educacao">
                    ...
                    <video class="video positionAbsolute" src="http://pratisys.com.br/cacau/video_sanofi_trade_q1/profenid_23_03_20.mp4" controls></video>
                ...
                <div class="content-page estrategia">
                    ...
                    <div data-layer-set=".ESTRA" class="ESTRA largumentos1 layer show">
                        ...
                        <span data-layer=".largumentos1" class="bts-layer-sku bt-layer-sku-4 active"></span>
                        <span data-layer=".largumentos2" class="bts-layer-sku bt-layer-sku-3 "></span>
                        <span data-layer=".largumentos3" class="bts-layer-sku bt-layer-sku-2 "></span>
                        <span data-layer=".largumentos4" class="bts-layer-sku bt-layer-sku-1"></span>
                    </div>

                    <div data-layer-set=".ESTRA" class="ESTRA largumentos2 layer">

                        <img class="positionAbsolute" src="../../webroot/img/produtos/<?php echo "$categoria/$produto/$produto" ?>Estrategia-2.png" style="z-index:1;top:23px;left:17px">
                        ...
                        <span data-layer=".largumentos1" class="bts-layer-sku bt-layer-sku-4 "></span>
                        <span data-layer=".largumentos2" class="bts-layer-sku bt-layer-sku-3 active"></span>
                        <span data-layer=".largumentos3" class="bts-layer-sku bt-layer-sku-2 "></span>
                        <span data-layer=".largumentos4" class="bts-layer-sku bt-layer-sku-1"></span>
                    </div>
                    ...
                    <div data-layer-set=".ESTRA" class="ESTRA largumentos3 layer">
                        ...
                        <img class="positionAbsolute" src="../../webroot/img/produtos/<?php echo "$categoria/$produto/$produto" ?>Estrategia-3.png" style="z-index:1;top:23px;left:17px">
                        ...
                        <span data-layer=".largumentos1" class="bts-layer-sku bt-layer-sku-4 "></span>
                        <span data-layer=".largumentos2" class="bts-layer-sku bt-layer-sku-3 "></span>
                        <span data-layer=".largumentos3" class="bts-layer-sku bt-layer-sku-2 active"></span>
                        <span data-layer=".largumentos4" class="bts-layer-sku bt-layer-sku-1"></span>
                    </div>

                    <div data-layer-set=".ESTRA" class="ESTRA largumentos4 layer">

                        <img class="positionAbsolute" src="../../webroot/img/produtos/<?php echo "$categoria/$produto/$produto" ?>Estrategia-4.png" style="z-index:1;top:23px;left:17px">
                        ...
                        <span data-layer=".largumentos2" class="bts-layer-sku bt-layer-sku-3 "></span>
                        <span data-layer=".largumentos3" class="bts-layer-sku bt-layer-sku-2 "></span>
                        <span data-layer=".largumentos4" class="bts-layer-sku bt-layer-sku-1 active"></span>
                    </div>
                </div>
