    ...
    <div class="btnProdutos btn-padrao btn-menu-superior positionAbsolute d-table">
        ...
        <div id="produtos">
            <div id="produtosMenu" data-menu-close-bg class="menu produtosMenu positionAbsolute">
                ...
                <a href="<?php echo linkInterno('Vitamedley');?>" >
                    <div class="positionAbsolute menu-cascade-produtos menu-vitamedley d-table">
                        <p class="d-table-cell v-align-middle">VITAMEDLEY</p>
                    </div>
                </a>
                
                <a href="<?php echo linkInterno('Lancamentos');?>" >
                    <div class="positionAbsolute menu-cascade-produtos menu-lancamentos d-table">
                        <p class="d-table-cell v-align-middle">LANÇAMENTOS</p>
                    </div>
                </a>
